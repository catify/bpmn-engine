...
@Transactional
public class IntermediateThrowEventNodeTest extends Base_nodes {
	...
	public void testUnmarshalling() throws FileNotFoundException, JAXBException {
		...
		List<TProcess> processList = getProcessesFromXML("testprocess_throw.bpmn");
	...
	public void testAkkaNodeCreation() throws FileNotFoundException,
		...
		final TFlowNode flowNode_jaxb = extractFlowNodes(process_jaxb).get("throwEvent1");
